 ...
 * Uses the IPartnerFinancialsService/GetDetailedSales interface.
 */
export async function etlSteamSalesApi({ sinceUtc, untilUtc }) {
  ...
  for (const appId of appIds) {
    try {
      ...
      // Steam Partner API parameters
      url.searchParams.set("key", key); 
      url.searchParams.set("appid", appId); 
      url.searchParams.set("start_date", sinceUtc.slice(0, 10)); // YYYY-MM-DD
      ...
      // Financial API returns data in response.data or simply data
