...
export async function etlSteamSalesApi({ sinceUtc, untilUtc }) {
  ...
  for (const appId of appIds) {
    try {
      ...
      // IPartnerFinancialsService uses these specific parameter names
      url.searchParams.set("key", key); 
      url.searchParams.set("appid", appId); 
      // Steam financial reports often require dates in YYYY-MM-DD format
      ...
      // Steam financial data is usually nested inside response.data
      let rawData = [];
